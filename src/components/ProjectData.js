...
const ProjectData = [
  ...
  },
  {
    ...
    description: 'A little labyrinth game built in React where we worked with storing the current state of the game using thunks and async actions in Redux. We flirted with some coding visual elements in the design.',
