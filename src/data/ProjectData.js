...
const ProjectData = [
  ...
  },
  {
    ...
    text: 'This site shows new releases from Spotify, with data from local json-data, and links to music on Spotify. This was a pair project and the first time we were using React, components, and JSX.',
  ...
  },
  {
    // img:
    title: 'Weather App',
    text: 'This weather site shows the current weather and a five day forecast in the chosen city by pulling data from the Open Weather API. to update the current and 5-day forecast. It changes color and weather icons based on the current conditions.',
    techLanguages: ['Javascript ES6', 'HTML5', 'CSS3'],
  ...
  {
    // img:
    title: 'GuessWho? The Game',
    text: 'This is a digital version of the classic board game "Guess Who?". It uses conditional statements, array methods and many more Javascript features to filter characters based on the players questions and finally lets you know if you have made the right guess or not!',
    techLanguages: ['Javascript ES6', 'HTML5', 'CSS3'],
    githubLink: 'https://github.com/fridanordenlow/project-weather-app',
    deployedLink: 'https://voluble-bonbon-854851.netlify.app'
  },
